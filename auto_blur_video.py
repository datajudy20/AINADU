...
def blur_circle(img, x1, y1, x2, y2): #Mosaic area setting
...
def draw_circle(event, x, y, flags, param):   #Mosaic processing through mouse click events
    print(i)
...
if net_type == 'slim': #ultra fast light mode
